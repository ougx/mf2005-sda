...
module SDA
  ...
  double precision, allocatable                ::  HTMP(:,:,:) ! store baseline HNEW
  double precision, allocatable                ::  HITER(:,:,:) ! head of the last iteration to construct flow coefficient matrix
